      ...
      try {
        ...
        if (data.status && data.data) {
          ...
          const kycPlan = {
            ...
            price: 'CONTACT US',
            period: 'CUSTOM',
            apiScans: 'KYC VERIFICATION',
            gradient: 'from-red-500 to-red-600',
            bgGradient: 'from-red-50 to-red-50',
            buttonColor: 'bg-red-500 hover:bg-red-600',
            popular: false,
            features: [
              { text: 'Identity verification & authentication', included: true },
              { text: 'Document validation & verification', included: true },
              { text: 'Compliance checks & monitoring', included: true },
              { text: 'AML/KYC screening process', included: true },
              { text: 'Real-time verification system', included: true },
              { text: 'Secure data handling & storage', included: true },
              { text: 'Custom API integration support', included: true },
              { text: 'Dedicated 24/7 support team', included: true },
              { text: 'Full regulatory and compliance suite', included: true }
            ],
            originalData: null
          };
                  ...
                  <svg viewBox="0 0 400 40" className="w-full h-4 sm:h-6" preserveAspectRatio="none">
                    <path 
                      ...
                      className={`fill-current ${plan.bgGradient.includes('purple') ? 'text-purple-50' : 
                        plan.bgGradient.includes('cyan') ? 'text-cyan-50' : 
                        plan.bgGradient.includes('orange') ? 'text-orange-50' : 'text-pink-50'}`}
                    />
                  </svg>
                </div>
              </div>
