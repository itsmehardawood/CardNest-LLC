// // components/business/PendingStatus.jsx
...
const PendingStatus = ({ verificationData, userData, submitSuccess, handleManualReload, router }) => {
  ...
  return (
    <div className="min-h-screen bg-black py-8 px-4">
      <div className="max-w-4xl mx-auto">
        {/* Header Section */}
        <div className="bg-black rounded-xl shadow-sm border border-gray-800 p-8 mb-6">
          <div className="text-center">
          ...
          <div className="p-6">
            ...
            <div className="bg-gray-900 rounded-lg p-4">
              <div className="flex items-center">
                ...
                <div>
                  <label className="text-sm font-medium text-gray-400">Submitted Date</label>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-3 mt-6">
          <button
            onClick={handleManualReload}
            className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-gray-300 bg-black border border-gray-700 rounded-md hover:bg-gray-900 hover:border-gray-600 transition-colors"
          >
            <RotateCcw className="w-4 h-4 mr-2" />
            Check Status
          </button>
