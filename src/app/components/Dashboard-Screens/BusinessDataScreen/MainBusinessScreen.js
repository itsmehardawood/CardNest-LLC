  ...
  useEffect(() => { 
    ...
    if (status === 'incomplete' && profile) {
      setBusinessInfo({
        ...
        account_holder_first_name: profile.account_holder?.first_name || '',
        account_holder_last_name: profile.account_holder?.last_name || '',
        account_holder_email: profile.account_holder?.email || '',
        account_holder_date_of_birth: profile.account_holder?.date_of_birth || '',
        account_holder_street: profile.account_holder?.street || '',
        account_holder_street_line2: profile.account_holder?.street_line2 || '',
        account_holder_city: profile.account_holder?.city || '',
        account_holder_state: profile.account_holder?.state || '',
        account_holder_zip_code: profile.account_holder?.zip_code || '',
        account_holder_country: profile.account_holder?.country || '',
        account_holder_id_type: profile.account_holder?.id_type || '',
        account_holder_id_number: profile.account_holder?.id_number || '',
