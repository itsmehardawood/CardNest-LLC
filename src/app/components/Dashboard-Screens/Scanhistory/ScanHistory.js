  ...
  return (
    <div className="bg-black rounded-lg shadow-sm border border-gray-800">
      <div className="p-4 sm:p-6 border-b border-gray-700">
        <h2 className="text-lg sm:text-xl font-semibold text-white">Scan History & Device Information</h2>
      </div>
      ...
      <div className="border-b border-gray-700">
        ...
        >
          <div className="flex items-center space-x-3">
            ...
            <h3 className="text-base sm:text-lg font-semibold text-white">Card Scan History</h3>
            {scanHistory.length > 0 && (
              <span className="text-sm text-gray-400">({scanHistory.length})</span>
            )}
          </div>
          <div className="flex items-center space-x-3">
            <button
          ...
          <div className="p-4 sm:p-6 max-h-[600px] overflow-y-auto">
            {loading ? (
              <div className="flex items-center justify-center py-8">
                ...
                <span className="ml-3 text-gray-300">Loading scan history...</span>
              </div>
            ) : error ? (
              <div className="text-center py-6 sm:py-8">
                <AlertCircle className="w-10 h-10 sm:w-12 sm:h-12 text-red-400 mx-auto mb-4" />
