                ...
                <div className="bg-black rounded-xl shadow-sm border border-gray-800 overflow-hidden">
                  ...
                  <div className="p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                      <div className="bg-blue-900 p-5 rounded-lg border border-blue-800 flex flex-col h-full">
                        ...
                        <div className="flex-grow">
                          <p className="text-4xl font-bold text-white">{getMonthlyLimit().toLocaleString()}</p>
                        </div>
                        <p className="text-sm text-gray-400 mt-2">API Calls</p>
                      </div>

                      <div className="bg-purple-900 p-5 rounded-lg border border-purple-800 flex flex-col h-full">
                        <div className="flex items-center mb-3">
                        ...
                        <div className="flex-grow">
                          <p className="text-4xl font-bold text-white">{getUsedCalls().toLocaleString()}</p>
                        </div>
                        <p className="text-sm text-gray-400 mt-2">API Calls</p>
                      </div>

                      <div className="bg-green-900 p-5 rounded-lg border border-green-800 flex flex-col h-full">
                        <div className="flex items-center mb-3">
                        ...
                        <div className="flex-grow">
                          <p className="text-4xl font-bold text-white">{getRemainingCalls().toLocaleString()}</p>
                        </div>
                        <p className="text-sm text-gray-400 mt-2">API Calls</p>
                      </div>
                    </div>
                    ...
                    {/* Custom Package Info */}
                    {isCustomPackage() && (
                      <div className="mb-8 bg-purple-900 p-4 rounded-lg border border-purple-800">
                        <h4 className="text-sm font-medium text-purple-300 uppercase tracking-wider mb-2">Custom Package Details</h4>
                    ...
                    <div className="bg-gray-900 p-4 rounded-lg border border-gray-700">
                      <div className="flex items-center justify-between">
                        ...
                        <p className="text-sm font-medium text-white">{formatDate(subscriptionData?.renewal_date)}</p>
                      </div>
                    </div>
                  </div>
                </div>
