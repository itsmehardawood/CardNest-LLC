              ...
              {subscriptionData?.package && (
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                  <div className="p-6 border-b border-gray-200">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                      <div>
                        <h3 className="text-2xl font-bold text-gray-900 mb-1">{getPlanName()}</h3>
                        <p className="text-gray-600 text-lg">{formatCurrency(getPlanPrice())} / {subscriptionData.package.package_period}</p>
                        {isCustomPackage() && (
                          <div className="mt-2">
                  ...
                  <div className="p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                      <div className="bg-blue-50 p-5 rounded-lg border border-blue-100">
                        ...
                        <p className="text-3xl font-bold text-gray-900">{getMonthlyLimit().toLocaleString()}</p>
                        <p className="text-sm text-gray-500">API Calls</p>
                      </div>
                      ...
                      <div className="bg-purple-50 p-5 rounded-lg border border-purple-100">
                        ...
                        <p className="text-3xl font-bold text-gray-900">{getUsedCalls().toLocaleString()}</p>
                        <p className="text-sm text-gray-500">API Calls</p>
                      </div>
                      ...
                      <div className="bg-green-50 p-5 rounded-lg border border-green-100">
                        ...
                        <p className="text-3xl font-bold text-gray-900">{getRemainingCalls().toLocaleString()}</p>
                        <p className="text-sm text-gray-500">API Calls</p>
                      </div>
                    </div>
                    ...
                    <div className="mb-8">
                      <div className="flex justify-between items-center mb-2">
                        <h4 className="text-sm font-medium text-gray-500 uppercase tracking-wider">Usage Progress</h4>
                        <span className="text-sm font-medium text-gray-600">{getUsagePercentage()}%</span>
                      </div>
                      <div className="w-full bg-gray-200 rounded-full h-2.5">
                        <div 
                          className={`h-2.5 rounded-full ${
                    ...
                    {isCustomPackage() && (
                      <div className="mb-8 bg-purple-50 p-5 rounded-lg border border-purple-200">
                        <h4 className="text-sm font-medium text-purple-900 uppercase tracking-wider mb-3">Custom Package Details</h4>
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          <div>
                            <span className="text-purple-700 font-medium">Custom API Count:</span>
                            <span className="ml-2 text-purple-900">{subscriptionData.custom_api_count.toLocaleString()}</span>
                          </div>
                          <div>
                            <span className="text-purple-700 font-medium">Custom Price:</span>
                            <span className="ml-2 text-purple-900">{formatCurrency(subscriptionData.custom_price)}</span>
                          </div>
                          {/* <div>
