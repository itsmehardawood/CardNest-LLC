...
//       {/* Modal Container */}
//       <div className="relative bg-black rounded-xl shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-hidden flex flex-col border border-gray-800" onClick={(e) => e.stopPropagation()}>
//         {/* Header */}
...
//             <div className="bg-black rounded-lg p-3 shadow-sm border border-gray-800">
//               <div className="text-2xl font-bold text-blue-400">{stats.uniqueUsers}</div>
//               <div className="text-xs text-gray-400">Unique Users</div>
//             </div>
//             <div className="bg-black rounded-lg p-3 shadow-sm border border-gray-800">
//               <div className="text-2xl font-bold text-purple-400">{stats.uniqueCards}</div>
...
//         <div className="px-6 py-4 bg-black border-b border-gray-800 flex-shrink-0">
//           <h4 className="text-lg font-semibold text-white mb-3">Merchant Information</h4>
//           <div className="bg-gray-900 rounded-lg p-4">
//             <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
//               <div className="flex items-center space-x-2">
//                 <span className="text-sm font-medium text-gray-400">Merchant ID:</span>
//                 <span className="text-sm font-mono bg-black text-gray-300 px-2 py-1 rounded border border-gray-700">{merchantInfo?.merchant_id}</span>
//               </div>
//               <div className="flex items-center space-x-2">
//                 <span className="text-sm font-medium text-gray-400">Merchant Key:</span>
//                 <span className="text-xs font-mono text-gray-300 bg-black px-2 py-1 rounded border border-gray-700 truncate max-w-xs">{merchantInfo?.merchant_key}</span>
//               </div>
//             </div>
//           </div>
//         </div>
...
//         {/* Card Scan Records */}
//         <div className="px-6 py-4 bg-black flex-1 overflow-y-auto">
//           <h4 className="text-lg font-semibold text-white mb-4">Card Scan Records</h4>
...
//                     {/* Card Info */}
//                     <div className="flex items-center space-x-2 bg-blue-900 rounded-lg px-3 py-2">
//                       {getCardIcon()}
//                       <div>
...
//                       <div className="text-lg font-bold text-white">{group.scan_count}</div>
...
//                     <span className="font-mono bg-gray-800 px-2 py-1 rounded text-gray-300">{group.merchant_key}</span>
//                   </div>
//                 </div>
//               </div>
//             ))}
...
//         {/* Footer */}
//         <div className="bg-gray-900 px-6 py-4 border-t border-gray-800 flex-shrink-0">
