          ...
          <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-lg p-3 sm:p-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="flex flex-col sm:flex-row sm:justify-between">
                    ...
                    <span className="font-medium text-sm sm:text-base">{subscription.user_id}</span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:justify-between">
                    <span className="text-gray-600 text-sm">Merchant ID:</span>
                    <span className="font-medium text-sm sm:text-base break-all">{subscription.merchant_id}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 rounded-lg p-3 sm:p-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="flex flex-col sm:flex-row sm:justify-between">
                    <span className="text-gray-600 text-sm">Package ID:</span>
                    <span className="font-medium text-sm sm:text-base">{subscription.package_id}</span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:justify-between">
                    <span className="text-gray-600 text-sm">Type:</span>
                    <span className="font-medium text-sm sm:text-base">{getPackageType(subscription)}</span>
                  </div>
                  {subscription.custom_price && (
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:col-span-2">
                      <span className="text-gray-600 text-sm">Custom Price:</span>
              ...
              <div className="bg-gray-50 rounded-lg p-3 sm:p-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <div className="flex flex-col sm:flex-row sm:justify-between">
                    ...
                    <span className="font-medium text-sm sm:text-base">{formatNumber(subscription.api_calls_used)}</span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:justify-between">
              ...
              <div className="bg-gray-50 rounded-lg p-3 sm:p-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="flex flex-col sm:flex-row sm:justify-between">
                    ...
                    <span className="font-medium text-sm sm:text-base">{formatDate(subscription.subscription_date)}</span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:justify-between">
                    <span className="text-gray-600 text-sm">Renewal:</span>
                    <span className="font-medium text-sm sm:text-base">{formatDate(subscription.renewal_date)}</span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:col-span-2">
            ...
            {subscription.custom_package && (
              <div className="space-y-4">
                ...
                <div className="bg-blue-50 rounded-lg p-3 sm:p-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div className="flex flex-col sm:flex-row sm:justify-between">
                      <span className="text-gray-600 text-sm">Custom Package:</span>
                      <span className="font-medium text-sm sm:text-base">{subscription.custom_package}</span>
                    </div>
                    <div className="flex flex-col sm:flex-row sm:justify-between">
                      <span className="text-gray-600 text-sm">Custom Status:</span>
                      <span className="font-medium text-sm sm:text-base">{subscription.custom_status || 'N/A'}</span>
                    </div>
                    <div className="flex flex-col sm:flex-row sm:justify-between">
                      <span className="text-gray-600 text-sm">Custom Calls Used:</span>
                      <span className="font-medium text-sm sm:text-base">{subscription.custom_calls_used || 'N/A'}</span>
                    </div>
                    <div className="flex flex-col sm:flex-row sm:justify-between">
